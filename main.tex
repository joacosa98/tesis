...
Además de estos materiales, la actividad cuenta con dos tarjetas adicionales, cada una con un tag específico a ser leído por el robot. El funcionamiento de cada una se explica en la sección~\ref{subsec:recorrido-completo} (Recorrido completo).
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.25\textwidth}
        ...
        \caption{Feedback final con error, dos posiciones en total}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.25\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/robotito/robotito-segmento-2.png}
        \caption{Feedback final con error, tres posiciones en total}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.25\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/robotito/robotito-segmento-3.png}
        \caption{Feedback final con error, cuatro posiciones en total}
    \end{subfigure}
